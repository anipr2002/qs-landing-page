...
const Icons: React.FC<IconsProps> = ({ name, size }) => {
  ...
  const iconMap: { [key: string]: React.ReactElement } = {
    ...
    whatsapp: <Icon fontSize={size} icon="logos:whatsapp-icon" />,
    discord: <Icon fontSize={size} icon="logos:discord-icon" />,
    zoom: <Icon fontSize={size} icon="logos:zoom" />,
    quora: <Icon fontSize={size} icon="logos:quora" />,
  };
